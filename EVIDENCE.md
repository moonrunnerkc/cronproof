...
- Generated: 2026-07-28T17:36:54.351Z
- Git SHA: 68ff2013eaa76738a55e7f3459c2b40923b8983b (working tree dirty)
...
````
 ...
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > the mocked timezone module throws when any export is called 20ms
 ...
 ✓ tests/hazard/acceptance.test.ts > */15 * * * * America/New_York over 2024 > zero SKIPPED, zero DOUBLED, exactly two INTERVAL_DRIFT 29ms
 ✓ tests/hazard/acceptance.test.ts > 0 0 * * * Pacific/Apia over 2011 > COUNT_ANOMALY for December 30, the calendar day that does not exist 5ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > */15 * * * * in vixie dialect yields no hazards in any UTC zone 80ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > ZONE_UNSTABLE labels predicted regions past the last recorded transition > a constant-offset zone past its last transition is not labeled unstable (extrapolation is exact) 2ms
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > fixtures exist for the required schedulers, both directions, both zones 2ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cronie matches observed firings for berlin-fall-wildcard 1ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > debian-cron matches observed firings for ny-spring-fixed 2ms
 ...
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 294ms
 ...
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the classifier assigns that same id to the hazard it produces 11ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id changes when any identity field changes 1ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id does not depend on severity, so the idempotence flag cannot change it 9ms
 ...
 ✓ tests/hazard/severity.test.ts > severity model > the idempotence flag flips a real doubled hazard from critical to low without changing anything else 18ms
 ...
 ✓ tests/cron/differential.test.ts > Quartz and AWS special day tokens > L in day-of-month fires on the actual last day of each month 0ms
 ...
 ✓ tests/cli/baseline.test.ts > baseline files > writing then reading returns the same ids, sorted and de-duplicated 8ms
 ...
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > a repo with a spring-forward/fall-back schedule reports high and critical hazards and fails 39ms
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > SARIF results carry a physical location so annotations land on the source line 13ms
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a baseline captured from the repo lets scan pass 28ms
 ...
 ✓ tests/cron/parse.test.ts > macros > @reboot parses as a reboot schedule that enumerates to nothing 7ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty human with a receipt 32ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 81ms
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > two json runs on identical inputs and tzdb are byte-for-byte identical 56ms
 ...
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > 'vixie' false for "'0 0 0 1 1 ?'": 'Vixie is 5-field; a seconds field is …' 10ms
 ...
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > 'k8s' false for "'0 0 L * ?'": 'the robfig standard parser has no "L"…' 4ms
 ...
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > 'quartz' true for "'0 0 0 ? * MON#5'": 'Quartz accepts the "#" nth-weekday to…' 4ms
 ...
 ✓ tests/scan/fixture.test.ts > unresolvable templates > a Spring property placeholder cron is reported UNRESOLVED 3ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 294ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 223ms
 ...
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > cronie fires a unique time once 1ms
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > k8s-cronjob fires a unique time once 2ms
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > quartz fires a unique time once 2ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 522ms
 ...
 ✓ tests/evidence-lib.test.ts > normalizeEvidence > makes two runs equal when they differ only in timestamp, git SHA, repo root, clock times, and durations 2ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > JUnit output validates against a JUnit schema 34ms
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 110ms

[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 10167ms

 Test Files  31 passed (31)
      Tests  260 passed (260)
   Start at  17:36:29
   Duration  10.54s (transform 3.01s, setup 0ms, import 5.62s, tests 12.69s, environment 4ms)
````
