...
- Generated: 2026-07-28T22:51:09.618Z
- Git SHA: abe517cad8e600bf8af395dc57ca90dfaf1c1a58 (working tree dirty)
...
````
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > */15 * * * * in vixie dialect yields no hazards in any UTC zone 79ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 0 0 * * * in vixie dialect yields no hazards in any UTC zone 9ms
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 30 5 * * 1-5 in github-actions dialect yields no hazards in any UTC zone 7ms
...
[property] partition seed=0x1a2b3c4d runs=300 firings=24797 skipped=61 doubled=62
 ✓ tests/property/hazard-invariants.property.test.ts > per-firing classification is a partition and the resolved-count invariant holds > every firing is unique, skipped, or doubled, exactly one of the three, and resolved = intended - skipped + doubled (seed 0x1a2b3c4d, 300 runs) 162ms
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 258ms
 ...
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > a fall-back DOUBLED renders a fold band and both resolved UTC instants 33ms
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > the SVG carries an accessible label so a screenshot is described 30ms
 ✓ tests/property/hazard-invariants.property.test.ts > enumeration is independent of traversal direction > unioning per-day slices in reverse day order yields the same firing set as one forward pass (seed 0x1a2b3c4d) 226ms
 ✓ tests/property/hazard-invariants.property.test.ts > UTC never produces a hazard > classifyHazards in UTC is empty for every generated expression and window (seed 0x1a2b3c4d, 300 runs) 94ms
 ...
 ✓ tests/hazard/sha256.test.ts > the pure-TypeScript sha256 matches node:crypto byte for byte > a thousand varied lengths all match node:crypto 91ms
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > 2024-03-10T02:30 America/New_York is nonexistent with a one-hour gap 24ms
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > Asia/Tehran shows transitions before 2022 and none after 46ms
 ...
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > the Intl and TZif backends report the same UTC offset at random instants across all 597 zones (seed 0x5eed7a11, 5000 runs) 467ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty human with a receipt 51ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty json with a receipt 5ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty sarif with a receipt 8ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 72ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 175ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan of a nonexistent path is a usage error 1ms
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > crossCheckZone finds zero transition disagreements over random windows and zones (seed 0x5eed7a11, 400 runs) 232ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Pacific/Apia: two date-line moves, a repeated day in 1892 and a missing day in 2011 > the 1892 move steps the offset back a full day and the 2011 move steps it forward a full day, erasing 2011-12-30 9ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Pacific/Kiritimati: the 1994 date-line move from UTC-10 to UTC+14 > a single 24-hour forward transition on 1994-12-31 erases that calendar day 9ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Asia/Tehran: DST abolished, last transition in 2022 > no transition exists after 2022 and a 2035 firing runs at the constant +3:30 footer offset with no ZONE_UNSTABLE label 15ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > Asia/Kolkata: a half-hour offset, no DST, its last transition deep in the past > the offset is a constant +5:30 with zero transitions in the modern era, so the POSIX footer governs every current firing 7ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > a DST footer governs firings past the last recorded transition (America/New_York) > a 2039 window, beyond the 2037 table end, is labelled ZONE_UNSTABLE with the last table transition as its boundary 33ms
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 0: a schedule with no hazards at or above the threshold 61ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 300ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 3: an internal verification failure (tzdb mismatch) 8ms
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 422ms
 ✓ tests/hazard/acceptance.test.ts > 30 2 * * * America/New_York over 2024 > exactly one SKIPPED on March 10, at 02:30, caused by the spring-forward transition 22ms
 ✓ tests/hazard/acceptance.test.ts > the November fall-back doubles 01:30, not 02:30 (documented correction) > 30 2 * * * is unique on November 3 (02:30 is not in the folded hour) 14ms
...
[property] hazard-id corpus size=60000 distinctIds=60000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > no two distinct identities share an id over a deterministic sweep of every dialect, zone, kind, and a dense date grid 1125ms
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > a repo with a spring-forward/fall-back schedule reports high and critical hazards and fails 38ms
 ...
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a baseline captured from the repo lets scan pass 21ms
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a hazard introduced after the baseline still fails while the baselined ones stay quiet 11ms
 ...
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Australia/Lord_Howe 3ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF uses the hazard id as the rule id and maps critical severity to error 3ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 247ms
 ...
 ✓ tests/hazard/severity.test.ts > severity model > the idempotence flag flips a real doubled hazard from critical to low without changing anything else 27ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id of a known hazard equals a pinned literal 3ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the classifier assigns that same id to the hazard it produces 15ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cron-parser-luxon matches observed firings for berlin-spring-wildcard 7ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > k8s-cronjob matches observed firings for berlin-spring-wildcard 5ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > systemd-timer matches observed firings for berlin-spring-wildcard 8ms
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > two json runs on identical inputs and tzdb are byte-for-byte identical 35ms
 ...
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > the mocked timezone module throws when any export is called 28ms
 ...
 ✓ tests/web/render.test.ts > the hazard list pairs each hazard with its timeline > a window with a skip and a double renders both cards, each containing an SVG 37ms
 ...
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a spring-forward interval schedule renders a table with a row per decision point and a cell per policy 1209ms
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a clean schedule reports no decision points rather than an empty table 32ms
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > 'vixie' false for "'0 0 0 1 1 ?'": 'Vixie is 5-field; a seconds field is …' 6ms
 ...
 ✓ tests/cron/parse.test.ts > source-level detail preserved for later phases > a literal leading asterisk is recorded distinctly from an equivalent value set 4ms
...
[parity] cases=50 totalHazards=42 zoneUnstable=0
 ✓ tests/web/parity.test.ts > the browser (Intl) verdict is identical to the CLI (TZif) verdict > all 50 fixed cases match the CLI on hazards, severity tally, and the scheduler differential 1651ms
 ...
 ✓ tests/scan/fixture.test.ts > scanning a repo with every supported source type > locates at least one schedule for each of the fourteen source kinds 2ms
 ✓ tests/scan/fixture.test.ts > scanning a repo with every supported source type > records the exact file, line, and column for a crontab entry 0ms
 ...
 ✓ tests/research/filter.test.ts > each exclusion rule removes the hits it is meant to and is counted > vendored, library-or-fixture, and fork hits are each excluded and charged to their rule 13ms
 ✓ tests/research/filter.test.ts > each exclusion rule removes the hits it is meant to and is counted > duplicate content is removed and the first occurrence in sorted order is kept 1ms
 ✓ tests/research/filter.test.ts > each exclusion rule removes the hits it is meant to and is counted > a hit that matches two rules is charged only to the first rule in order 0ms
 ✓ tests/research/filter.test.ts > filtering is deterministic > the same hits produce the same corpus rows and the same counts on every run 0ms
 ...
 ✓ tests/research/metrics.test.ts > a differing firing count is the portability defect > k8sDebianDiffer is true only when both counts exist and differ 0ms
...
[property] hazard-id random distinctIds=20000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > randomly generated distinct identities never map to the same id (seed 0xc0111de5, 20000 runs) 1084ms

[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 10696ms

 Test Files  42 passed (42)
      Tests  309 passed (309)
   Start at  22:50:44
   Duration  11.04s (transform 3.50s, setup 0ms, import 7.63s, tests 19.99s, environment 5ms)
````
