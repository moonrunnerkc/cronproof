...
- Generated: 2026-07-28T19:26:06.946Z
- Git SHA: ba811882b3eeddc1a8ee21d079aad888451c0846 (working tree dirty)
...
````
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > */15 * * * * in vixie dialect yields no hazards in any UTC zone 102ms
 ✓ tests/hazard/acceptance.test.ts > 30 2 * * * America/New_York over 2024 > exactly one SKIPPED on March 10, at 02:30, caused by the spring-forward transition 23ms
 ...
 ✓ tests/hazard/acceptance.test.ts > the November fall-back doubles 01:30, not 02:30 (documented correction) > 30 1 * * * has exactly one DOUBLED on November 3 at 01:30 with both instants 5ms
 ✓ tests/hazard/acceptance.test.ts > */15 * * * * America/New_York over 2024 > zero SKIPPED, zero DOUBLED, exactly two INTERVAL_DRIFT 45ms
 ...
 ✓ tests/hazard/acceptance.test.ts > Australia/Lord_Howe October 30-minute transition > 15 2 * * * is SKIPPED at the October 2024 transition 22ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 30 2 * * * in vixie dialect yields no hazards in any UTC zone 24ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 30 5 * * 1-5 in github-actions dialect yields no hazards in any UTC zone 10ms
 ✓ tests/hazard/zone-and-null.test.ts > ZONE_UNSTABLE labels predicted regions past the last recorded transition > a daily job the year after New York's last table transition is labeled footer-extrapolation 23ms
...
[property] partition seed=0x1a2b3c4d runs=300 firings=24797 skipped=61 doubled=62
 ✓ tests/property/hazard-invariants.property.test.ts > per-firing classification is a partition and the resolved-count invariant holds > every firing is unique, skipped, or doubled, exactly one of the three, and resolved = intended - skipped + doubled (seed 0x1a2b3c4d, 300 runs) 191ms
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 298ms
 ...
 ✓ tests/property/hazard-invariants.property.test.ts > enumeration is independent of traversal direction > unioning per-day slices in reverse day order yields the same firing set as one forward pass (seed 0x1a2b3c4d) 261ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > Pacific/Kiritimati: the 1994 date-line move from UTC-10 to UTC+14 > a single 24-hour forward transition on 1994-12-31 erases that calendar day 4ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Asia/Tehran: DST abolished, last transition in 2022 > no transition exists after 2022 and a 2035 firing runs at the constant +3:30 footer offset with no ZONE_UNSTABLE label 11ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > America/Sao_Paulo: DST abolished, last transition in 2019 > no transition exists after 2019 and the offset is a constant -3h through 2030 7ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Africa/Casablanca: more than two transitions in a year, from the Ramadan pause > 2017 has four transitions and the +1h base offset drops to 0 during the 2024 Ramadan window 2ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > a DST footer governs firings past the last recorded transition (America/New_York) > a 2039 window, beyond the 2037 table end, is labelled ZONE_UNSTABLE with the last table transition as its boundary 22ms

[property] hazard-id corpus size=60000 distinctIds=60000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > no two distinct identities share an id over a deterministic sweep of every dialect, zone, kind, and a dense date grid 532ms
 ✓ tests/property/hazard-invariants.property.test.ts > UTC never produces a hazard > classifyHazards in UTC is empty for every generated expression and window (seed 0x1a2b3c4d, 300 runs) 98ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id of a known hazard equals a pinned literal 7ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the classifier assigns that same id to the hazard it produces 16ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id changes when any identity field changes 2ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id does not depend on severity, so the idempotence flag cannot change it 22ms
 ...
 ✓ tests/hazard/severity.test.ts > severity model > the idempotence flag flips a real doubled hazard from critical to low without changing anything else 26ms
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > the Intl and TZif backends report the same UTC offset at random instants across all 597 zones (seed 0x5eed7a11, 5000 runs) 507ms
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > a repo with a spring-forward/fall-back schedule reports high and critical hazards and fails 47ms
 ...
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a baseline captured from the repo lets scan pass 36ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty human with a receipt 40ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > explain produces valid json for a fold transition 9ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 68ms
 ...
 ✓ tests/tz/acceptance.test.ts > tzif backend > 2024-03-10T02:30 America/New_York is nonexistent with a one-hour gap 8ms
 ...
 ✓ tests/tz/acceptance.test.ts > tzif backend > Europe/Dublin resolves correctly under negative DST: winter offset 0, summer offset +1h, gap and fold at the transitions 2ms
 ...
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > crossCheckZone finds zero transition disagreements over random windows and zones (seed 0x5eed7a11, 400 runs) 246ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cron-parser-luxon matches observed firings for berlin-fall-fixed 9ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > croniter matches observed firings for berlin-fall-wildcard 6ms
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > croniter matches observed firings for berlin-spring-wildcard 6ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > debian-cron matches observed firings for ny-fall-fixed 2ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1: a hazard at or above --fail-on (a critical DOUBLED, default fail-on high) 4ms
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 327ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 263ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan of a nonexistent path is a usage error 1ms
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > the mocked timezone module throws when any export is called 48ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 3: an internal verification failure (tzdb mismatch) 7ms
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 477ms
 ...
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Europe/Berlin 6ms
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in America/New_York 11ms
...
[property] hazard-id random distinctIds=20000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > randomly generated distinct identities never map to the same id (seed 0xc0111de5, 20000 runs) 920ms
 ...
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > naive fires a unique time once 9ms
 ...
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > systemd-timer fires a unique time once 1ms
 ...
 ✓ tests/policy/models.test.ts > k8s-cronjob has no fold suppression and skips gaps > fall-back fires twice 1ms
 ...
 ✓ tests/cli/baseline.test.ts > baseline files > writing then reading returns the same ids, sorted and de-duplicated 7ms
 ✓ tests/cli/baseline.test.ts > baseline files > reading a nonexistent baseline throws a message that says how to make one 8ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 355ms
 ✓ tests/adversarial/gaps-and-folds.test.ts > America/New_York: a one-hour spring gap and a one-hour fall fold > 02:30 on 2024-03-10 is nonexistent with a one-hour gap, 01:30 on 2024-11-03 is ambiguous with a one-hour fold 14ms
 ✓ tests/adversarial/gaps-and-folds.test.ts > Europe/Dublin: negative DST, so the DST flag is set in winter > January is the DST variant at offset 0 and July is standard time at +1h 10ms
 ✓ tests/adversarial/gaps-and-folds.test.ts > Australia/Lord_Howe: a 30-minute DST shift, not the usual hour > the 2024 transitions move the clock by exactly 1800 seconds, and 02:15 is skipped while 02:45 exists 5ms
 ...
 ✓ tests/adversarial/gaps-and-folds.test.ts > Europe/Lisbon: the ordinary EU rule, as a control > offset is 0 in winter and +1h in summer, with transitions on the last Sundays of March and October 2024 3ms
...
[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 10789ms

 Test Files  36 passed (36)
      Tests  282 passed (282)
   Start at  19:25:40
   Duration  11.17s (transform 4.25s, setup 0ms, import 8.53s, tests 16.74s, environment 5ms)
````
