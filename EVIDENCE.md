...
- Generated: 2026-07-28T17:56:02.601Z
- Git SHA: baee75b7f24a9b00d26f33fdf32246b08dcafd1f (working tree dirty)
...
````
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > Asia/Tehran shows transitions before 2022 and none after 32ms
 ...
 ✓ tests/hazard/acceptance.test.ts > 30 2 * * * America/New_York over 2024 > exactly one SKIPPED on March 10, at 02:30, caused by the spring-forward transition 19ms
 ...
 ✓ tests/hazard/acceptance.test.ts > the November fall-back doubles 01:30, not 02:30 (documented correction) > 30 1 * * * has exactly one DOUBLED on November 3 at 01:30 with both instants 3ms
 ...
 ✓ tests/hazard/acceptance.test.ts > Australia/Lord_Howe October 30-minute transition > 15 2 * * * is SKIPPED at the October 2024 transition 3ms
 ✓ tests/hazard/acceptance.test.ts > Australia/Lord_Howe October 30-minute transition > 45 2 * * * produces no hazards, because 02:45 exists after the 30-minute shift 6ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 0 0 * * * in vixie dialect yields no hazards in any UTC zone 7ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > ZONE_UNSTABLE labels predicted regions past the last recorded transition > a daily job the year after New York's last table transition is labeled footer-extrapolation 12ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > croniter matches observed firings for berlin-fall-wildcard 1ms
 ...
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 270ms
 ...
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > two json runs on identical inputs and tzdb are byte-for-byte identical 34ms
 ...
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > SARIF results carry a physical location so annotations land on the source line 12ms
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a baseline captured from the repo lets scan pass 33ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty human with a receipt 37ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 73ms
 ...
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Europe/Berlin 15ms
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in America/New_York 16ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 182ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan of a nonexistent path is a usage error 1ms
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 0: a schedule with no hazards at or above the threshold 44ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 268ms
 ...
 ✓ tests/cron/parse.test.ts > source-level detail preserved for later phases > a literal leading asterisk is recorded distinctly from an equivalent value set 9ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 465ms
 ...
 ✓ tests/scan/fixture.test.ts > scanning a repo with every supported source type > records the exact file, line, and column for a crontab entry 2ms
 ...
 ✓ tests/scan/fixture.test.ts > CRON_TZ inheritance > an entry before any CRON_TZ has an unknown zone 1ms
 ✓ tests/scan/fixture.test.ts > CRON_TZ inheritance > an entry after CRON_TZ inherits that zone and cites the line it came from 1ms
 ...
 ✓ tests/tz/posix-tz.test.ts > POSIX TZ footer parsing > parses angle-bracket names, explicit DST offsets, and rule times (Antarctica/Troll footer) 3ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 193ms
...
[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 10065ms

 Test Files  31 passed (31)
      Tests  260 passed (260)
   Start at  17:55:38
   Duration  10.40s (transform 2.89s, setup 0ms, import 5.57s, tests 12.58s, environment 4ms)
````
