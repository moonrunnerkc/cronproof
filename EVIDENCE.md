...
- Generated: 2026-07-28T23:30:20.551Z
- Git SHA: ff1b67abed024cc8705992ee16085445d1a8d882 (working tree dirty)
...
````
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > */15 * * * * in vixie dialect yields no hazards in any UTC zone 86ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 0 0 * * * in vixie dialect yields no hazards in any UTC zone 8ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > ZONE_UNSTABLE labels predicted regions past the last recorded transition > a daily job the year after New York's last table transition is labeled footer-extrapolation 19ms
...
[property] partition seed=0x1a2b3c4d runs=300 firings=24797 skipped=61 doubled=62
 ✓ tests/property/hazard-invariants.property.test.ts > per-firing classification is a partition and the resolved-count invariant holds > every firing is unique, skipped, or doubled, exactly one of the three, and resolved = intended - skipped + doubled (seed 0x1a2b3c4d, 300 runs) 176ms
 ✓ tests/import-surface/import-surface.test.ts > every library module imports cleanly in a scrubbed, offline, unauthenticated process > importing all of src/ and research/src/ throws nothing and opens no network connection 418ms
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > a spring-forward SKIPPED renders an SVG with a gap band and the intended time marked skipped 44ms
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > a fall-back DOUBLED renders a fold band and both resolved UTC instants 18ms
 ...
 ✓ tests/web/render.test.ts > the hazard list pairs each hazard with its timeline > a window with a skip and a double renders both cards, each containing an SVG 36ms
 ✓ tests/property/hazard-invariants.property.test.ts > enumeration is independent of traversal direction > unioning per-day slices in reverse day order yields the same firing set as one forward pass (seed 0x1a2b3c4d) 270ms
 ✓ tests/property/hazard-invariants.property.test.ts > UTC never produces a hazard > classifyHazards in UTC is empty for every generated expression and window (seed 0x1a2b3c4d, 300 runs) 78ms
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > the Intl and TZif backends report the same UTC offset at random instants across all 597 zones (seed 0x5eed7a11, 5000 runs) 468ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty markdown with a receipt 4ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > explain produces valid json for a fold transition 6ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 71ms
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 331ms
 ...
 ✓ tests/hazard/sha256.test.ts > the pure-TypeScript sha256 matches node:crypto byte for byte > a thousand varied lengths all match node:crypto 173ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 220ms
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 0: a schedule with no hazards at or above the threshold 53ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 291ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan of a nonexistent path is a usage error 1ms
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > crossCheckZone finds zero transition disagreements over random windows and zones (seed 0x5eed7a11, 400 runs) 269ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 3: an internal verification failure (tzdb mismatch) 19ms
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 427ms

[property] hazard-id corpus size=60000 distinctIds=60000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > no two distinct identities share an id over a deterministic sweep of every dialect, zone, kind, and a dense date grid 1082ms
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > 2024-03-10T02:30 America/New_York is nonexistent with a one-hour gap 18ms
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > Asia/Tehran shows transitions before 2022 and none after 57ms
 ✓ tests/tz/acceptance.test.ts > negative DST data is reported raw, never as a season proxy > vendored TZif reports Europe/Dublin winter as the DST variant at offset 0 and summer as standard time at +1h 5ms
 ...
 ✓ tests/hazard/acceptance.test.ts > the November fall-back doubles 01:30, not 02:30 (documented correction) > 30 1 * * * has exactly one DOUBLED on November 3 at 01:30 with both instants 11ms
 ✓ tests/hazard/acceptance.test.ts > */15 * * * * America/New_York over 2024 > zero SKIPPED, zero DOUBLED, exactly two INTERVAL_DRIFT 53ms
 ...
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > SARIF results carry a physical location so annotations land on the source line 16ms
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a baseline captured from the repo lets scan pass 30ms
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a hazard introduced after the baseline still fails while the baselined ones stay quiet 21ms
 ✓ tests/cli/scan-gate.test.ts > tzdb pin > a wrong pin fails with the internal exit code before any scanning 2ms
 ✓ tests/hazard/acceptance.test.ts > Australia/Lord_Howe October 30-minute transition > 15 2 * * * is SKIPPED at the October 2024 transition 8ms
 ✓ tests/hazard/acceptance.test.ts > Australia/Lord_Howe October 30-minute transition > 45 2 * * * produces no hazards, because 02:45 exists after the 30-minute shift 8ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > JUnit output validates against a JUnit schema 37ms
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 277ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cron-parser-luxon matches observed firings for berlin-fall-fixed 6ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cron-parser-luxon matches observed firings for berlin-fall-wildcard 13ms
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cron-parser-luxon matches observed firings for berlin-spring-wildcard 2ms
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cronie matches observed firings for berlin-fall-fixed 0ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > croniter matches observed firings for berlin-spring-wildcard 3ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > cronsim matches observed firings for berlin-fall-wildcard 2ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > Pacific/Apia: two date-line moves, a repeated day in 1892 and a missing day in 2011 > the 1892 move steps the offset back a full day and the 2011 move steps it forward a full day, erasing 2011-12-30 5ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > Asia/Tehran: DST abolished, last transition in 2022 > no transition exists after 2022 and a 2035 firing runs at the constant +3:30 footer offset with no ZONE_UNSTABLE label 14ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > America/Sao_Paulo: DST abolished, last transition in 2019 > no transition exists after 2019 and the offset is a constant -3h through 2030 9ms
 ✓ tests/adversarial/date-line-and-rules.test.ts > Africa/Casablanca: more than two transitions in a year, from the Ramadan pause > 2017 has four transitions and the +1h base offset drops to 0 during the 2024 Ramadan window 6ms
 ...
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > two json runs on identical inputs and tzdb are byte-for-byte identical 52ms
 ...
 ✓ tests/web/permalink.test.ts > the permalink round-trips the full input state > decoding an encoded state reproduces every field 3ms
 ...
 ✓ tests/policy/differential.test.ts > 30 2 * * * Europe/Berlin at the 2023 fall-back > debian-cron fires once, k8s-cronjob fires twice, naive fires twice, and the disagreement is reported 9ms
 ...
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Europe/Berlin 9ms
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in America/New_York 7ms
 ...
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Pacific/Apia 6ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id of a known hazard equals a pinned literal 2ms
 ...
 ✓ tests/web/render.test.ts > the hazard list pairs each hazard with its timeline > a clean window says so instead of rendering an empty list 14ms
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a spring-forward interval schedule renders a table with a row per decision point and a cell per policy 1272ms
 ...
 ✓ tests/hazard/severity.test.ts > severity model > the idempotence flag flips a real doubled hazard from critical to low without changing anything else 38ms
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a clean schedule reports no decision points rather than an empty table 31ms
 ...
 ✓ tests/cron/parse.test.ts > day-of-week numbering canonicalizes to 0 (Sunday) through 6 > weekday and month names resolve case-insensitively to the same canonical values 0ms
 ✓ tests/cron/parse.test.ts > macros > @midnight and @daily expand to the same midnight schedule 1ms
 ✓ tests/cron/parse.test.ts > macros > @reboot parses as a reboot schedule that enumerates to nothing 0ms
 ✓ tests/cron/parse.test.ts > error locations > an out-of-range value reports the offset of the offending field 0ms
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > the mocked timezone module throws when any export is called 34ms
 ...
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > enumeration output is identical regardless of the zone argument 8ms
 ...
 ✓ tests/cron/differential.test.ts > day-of-month / day-of-week combination > Vixie OR quirk: with both day fields restricted, the 13th fires even though it is not a Friday 8ms
 ...
 ✓ tests/research/filter.test.ts > each exclusion rule removes the hits it is meant to and is counted > vendored, library-or-fixture, and fork hits are each excluded and charged to their rule 25ms
 ✓ tests/research/filter.test.ts > each exclusion rule removes the hits it is meant to and is counted > duplicate content is removed and the first occurrence in sorted order is kept 3ms
...
[parity] cases=50 totalHazards=42 zoneUnstable=0
 ✓ tests/web/parity.test.ts > the browser (Intl) verdict is identical to the CLI (TZif) verdict > all 50 fixed cases match the CLI on hazards, severity tally, and the scheduler differential 1753ms
 ...
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > 'debian' false for "'0 0 1 1 ?'": 'Debian (Vixie extensions) has no "?" …' 5ms
 ...
 ✓ tests/cron/dialect-rejection.test.ts > dialect acceptance and rejection > every dialect rejects at least one expression that another dialect accepts 5ms
 ✓ tests/policy/models.test.ts > every policy fires a unique time once at its instant > naive fires a unique time once 5ms
 ...
 ✓ tests/adversarial/gaps-and-folds.test.ts > America/New_York: a one-hour spring gap and a one-hour fall fold > 02:30 on 2024-03-10 is nonexistent with a one-hour gap, 01:30 on 2024-11-03 is ambiguous with a one-hour fold 6ms
 ...
 ✓ tests/tz/tzif-parse.test.ts > TZif binary parsing > reads the 64-bit transition table and footer of America/New_York 5ms
 ...
 ✓ tests/tz/posix-tz.test.ts > POSIX TZ footer parsing > parses a US-style rule with east-positive offsets 10ms
...
[property] hazard-id random distinctIds=20000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > randomly generated distinct identities never map to the same id (seed 0xc0111de5, 20000 runs) 1175ms
 ✓ tests/scan/suppression-and-ignore.test.ts > inline suppression comments > a suppression with a reason removes the finding and records the reason 1ms
 ...
 ✓ tests/tz/versions.test.ts > tzdb version reporting > reports the Intl tzdb version and the zoneinfo tzdb version separately 2ms
...
[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 10822ms

 Test Files  43 passed (43)
      Tests  310 passed (310)
   Start at  23:29:54
   Duration  11.20s (transform 3.81s, setup 0ms, import 8.08s, tests 21.13s, environment 6ms)
````
