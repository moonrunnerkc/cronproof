...
- Generated: 2026-07-28T19:53:19.221Z
- Git SHA: ca354f947172350569db68a47e77cdeff3f2e1fd (working tree dirty)
...
````
 ...
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > */15 * * * * in vixie dialect yields no hazards in any UTC zone 92ms
 ✓ tests/hazard/zone-and-null.test.ts > null test: UTC schedules produce zero hazards > 30 2 * * * in vixie dialect yields no hazards in any UTC zone 20ms
 ...
 ✓ tests/hazard/zone-and-null.test.ts > ZONE_UNSTABLE labels predicted regions past the last recorded transition > a daily job the year after New York's last table transition is labeled footer-extrapolation 13ms
...
[property] partition seed=0x1a2b3c4d runs=300 firings=24797 skipped=61 doubled=62
 ✓ tests/property/hazard-invariants.property.test.ts > per-firing classification is a partition and the resolved-count invariant holds > every firing is unique, skipped, or doubled, exactly one of the three, and resolved = intended - skipped + doubled (seed 0x1a2b3c4d, 300 runs) 182ms
 ✓ tests/tz/cross-check.test.ts > backend cross-check > both backends agree on every transition instant and offset for hazard-heavy zones, 1970 to 2040 288ms
 ...
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > a spring-forward SKIPPED renders an SVG with a gap band and the intended time marked skipped 45ms
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > a fall-back DOUBLED renders a fold band and both resolved UTC instants 24ms
 ✓ tests/web/render.test.ts > the timeline strip marks the intended firing inside the gap or fold > the SVG carries an accessible label so a screenshot is described 24ms
 ...
 ✓ tests/property/hazard-invariants.property.test.ts > enumeration is independent of traversal direction > unioning per-day slices in reverse day order yields the same firing set as one forward pass (seed 0x1a2b3c4d) 260ms
 ✓ tests/property/hazard-invariants.property.test.ts > UTC never produces a hazard > classifyHazards in UTC is empty for every generated expression and window (seed 0x1a2b3c4d, 300 runs) 87ms
 ✓ tests/hazard/acceptance.test.ts > 30 2 * * * America/New_York over 2024 > exactly one SKIPPED on March 10, at 02:30, caused by the spring-forward transition 18ms
 ✓ tests/hazard/acceptance.test.ts > the November fall-back doubles 01:30, not 02:30 (documented correction) > 30 2 * * * is unique on November 3 (02:30 is not in the folded hour) 8ms
 ...
 ✓ tests/hazard/acceptance.test.ts > 0 0 * * * Pacific/Apia over 2011 > COUNT_ANOMALY for December 30, the calendar day that does not exist 6ms
 ...
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > the Intl and TZif backends report the same UTC offset at random instants across all 597 zones (seed 0x5eed7a11, 5000 runs) 463ms
 ✓ tests/cli/scan-gate.test.ts > scan as a CI gate over classified hazards > a repo with a spring-forward/fall-back schedule reports high and critical hazards and fails 41ms
 ...
 ✓ tests/cli/scan-gate.test.ts > baseline adoption > a hazard introduced after the baseline still fails while the baselined ones stay quiet 19ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > check emits non-empty human with a receipt 34ms
 ...
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > zones produces valid json listing affected zones 99ms
 ✓ tests/cli/scan-gate.test.ts > tzdb pin > a wrong pin fails with the internal exit code before any scanning 1ms
 ✓ tests/property/backend-agreement.property.test.ts > the two timezone backends never disagree > crossCheckZone finds zero transition disagreements over random windows and zones (seed 0x5eed7a11, 400 runs) 233ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan finds schedules in a repo and reports them as json 199ms
 ✓ tests/cli/formats.test.ts > all five formats emit output for every command > scan of a nonexistent path is a usage error 7ms
 ...
 ✓ tests/hazard/sha256.test.ts > the pure-TypeScript sha256 matches node:crypto byte for byte > a thousand varied lengths all match node:crypto 136ms
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 0: a schedule with no hazards at or above the threshold 62ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 1 is threshold-sensitive: a medium INTERVAL_DRIFT passes at high but fails at medium 323ms
 ...
 ✓ tests/cli/exit-codes.test.ts > exit codes are a contract, asserted for every value > 3: an internal verification failure (tzdb mismatch) 12ms
 ✓ tests/tz/acceptance.test.ts > tzif backend > 2024-03-10T02:30 America/New_York is nonexistent with a one-hour gap 13ms
 ...
 ✓ tests/tz/acceptance.test.ts > intl backend > Asia/Tehran shows transitions before 2022 and none after 53ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > SARIF output validates against the official SARIF 2.1.0 schema 513ms

[property] hazard-id corpus size=60000 distinctIds=60000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > no two distinct identities share an id over a deterministic sweep of every dialect, zone, kind, and a dense date grid 1108ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > America/Sao_Paulo: DST abolished, last transition in 2019 > no transition exists after 2019 and the offset is a constant -3h through 2030 13ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > America/Santiago: southern hemisphere, so DST spans the new year > January is daylight time at -3h and July is standard time at -4h, with transitions in autumn and spring 5ms
 ...
 ✓ tests/adversarial/date-line-and-rules.test.ts > a DST footer governs firings past the last recorded transition (America/New_York) > a 2039 window, beyond the 2037 table end, is labelled ZONE_UNSTABLE with the last table transition as its boundary 27ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the id of a known hazard equals a pinned literal 3ms
 ✓ tests/hazard/hazard-id.test.ts > hazard id stability > the classifier assigns that same id to the hazard it produces 27ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > debian-cron matches observed firings for berlin-fall-fixed 5ms
 ...
 ✓ tests/policy/fixture-verification.test.ts > every model reproduces its real observed fixture > systemd-timer matches observed firings for berlin-spring-wildcard 7ms
 ...
 ✓ tests/cli/schema.test.ts > output validates against real schemas, not by inspection > a clean run still produces schema-valid SARIF and JUnit 224ms
 ✓ tests/policy/differential.test.ts > 30 2 * * * Europe/Berlin at the 2023 fall-back > debian-cron fires once, k8s-cronjob fires twice, naive fires twice, and the disagreement is reported 8ms
 ✓ tests/policy/differential.test.ts > */10 * * * * at spring forward > debian-cron and naive agree, because the wildcard path disables special handling 3ms
 ✓ tests/policy/differential.test.ts > a 04:00 schedule is the safe case > total agreement across all policies in Europe/Berlin 7ms
 ...
 ✓ tests/web/permalink.test.ts > the permalink round-trips the full input state > decoding an encoded state reproduces every field 6ms
 ...
 ✓ tests/web/permalink.test.ts > check my next transition brackets the upcoming change > for a DST zone it returns the next transition and a window that contains it 25ms
 ...
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > two json runs on identical inputs and tzdb are byte-for-byte identical 51ms
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > the json receipt carries an input hash and a result hash 5ms
 ✓ tests/cli/reproducibility.test.ts > reproducibility is the proof claim > a different expression changes the result hash 8ms
 ...
 ✓ tests/hazard/severity.test.ts > severity model > the idempotence flag flips a real doubled hazard from critical to low without changing anything else 19ms
 ...
 ✓ tests/cron/tz-isolation.test.ts > enumeration is independent of the timezone module > the mocked timezone module throws when any export is called 40ms
 ...
 ✓ tests/cron/differential.test.ts > Quartz and AWS special day tokens > nW picks the weekday nearest the target, staying inside the month 4ms
 ...
 ✓ tests/web/render.test.ts > the hazard list pairs each hazard with its timeline > a clean window says so instead of rendering an empty list 17ms
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a spring-forward interval schedule renders a table with a row per decision point and a cell per policy 1352ms
 ✓ tests/adversarial/gaps-and-folds.test.ts > America/New_York: a one-hour spring gap and a one-hour fall fold > 02:30 on 2024-03-10 is nonexistent with a one-hour gap, 01:30 on 2024-11-03 is ambiguous with a one-hour fold 5ms
 ...
 ✓ tests/web/render.test.ts > the disagreement matrix shows what each scheduler does per decision point > a clean schedule reports no decision points rather than an empty table 28ms
 ...
 ✓ tests/scan/fixture.test.ts > CRON_TZ inheritance > a mid-file CRON_TZ redeclaration affects only the entries after it 2ms
...
[parity] cases=50 totalHazards=42 zoneUnstable=0
 ✓ tests/web/parity.test.ts > the browser (Intl) verdict is identical to the CLI (TZif) verdict > all 50 fixed cases match the CLI on hazards, severity tally, and the scheduler differential 1744ms
...
[property] hazard-id random distinctIds=20000 collisions=0
 ✓ tests/property/hazard-id.property.test.ts > hazard ids are collision-free across a large generated corpus > randomly generated distinct identities never map to the same id (seed 0xc0111de5, 20000 runs) 1080ms

[property] seed=0xc0ffee5 cases=10000 parsed=10000 totalFirings=1084685
 ✓ tests/cron/property.test.ts > randomly generated valid expressions > enumerate deterministically and in strict wall-clock order over a one-year window (seed 0xc0ffee5, 10000 cases) 11101ms

 Test Files  40 passed (40)
      Tests  301 passed (301)
   Start at  19:52:53
   Duration  11.47s (transform 3.64s, setup 0ms, import 7.61s, tests 20.84s, environment 5ms)
````
